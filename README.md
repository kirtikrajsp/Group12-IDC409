...
We initially coded everything from scratch on Google Colab because of its simplicity and ease of use. In the later stages, we pushed the our code to GitHub for sharing.
